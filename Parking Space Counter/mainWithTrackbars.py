...
"""This code is just to pick the values of thresholds and imgMedian value"""
...
cv2.createTrackbar("Val1", "Vals", 15, 50, empty)
cv2.createTrackbar("Val2", "Vals", 3, 50, empty)
cv2.createTrackbar("Val3", "Vals", 1, 50, empty)
